		...
		<div id="scroll-steps">
			...
			<section class="scroll-step">
				<div class="scroll-step-content">
					...
					<p>
						The size of the circle represents the approximate length of the fragment. That means if
						a fragment is longer, its circle will be <big>bigger</big>, and if a fragment is
			...
			<section class="scroll-step step">
				<div class="scroll-step-content">
					...
					<p>
						This makes sense - larger fragments have more <b><i>"gravity"</i></b> - the longer they are,
						the more words they have, and the more words there are, the more likely the algorithm will
						find word similarities between fragments.
					</p>
				</div>
			</section>
			<section class="scroll-step step">
			...
			<section class="scroll-step step">
				<div class="scroll-step-content">
					<p style="margin-bottom: 2rem;">The smallest cluster is made up of 3 short fragments.</p>
          ...
          -webkit-text-fill-color: transparent;"
			...
			<section class="scroll-step step">
				<div class="scroll-step-content" style="text-align: center;">
					...
					<p>
						<small>
							Search for any word to fade in and out fragments that have those words. To search for
							multiple words, separate each word with a comma.
						</small>
					</p>
				</div>
			</section>
